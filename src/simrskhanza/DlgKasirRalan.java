...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnAwalKeperawatan.setText("Pengkajian Awal Keperawatan");
        ...
        MnAwalMedis.setText("Pengkajian Awal Medis");
        ...
        MnPenilaianPsikolog.setText("Pengkajian Psikolog");
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj left join bridging_sep on reg_periksa.no_rawat=bridging_sep.no_rawat and bridging_sep.jnspelayanan='2' where "+
